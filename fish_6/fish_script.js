...
class Predator {
    ...
    display() {
        ...
        // + PI/2 is to make the triangle point upwards initially
        ...
        stroke(0);
        strokeWeight(0.4);
        // adding sin() function to tail vertices
        ...
        endShape(CLOSE);
        // Draw a decorative wave
        this.preyEaten > 0 ? stroke(255, 255, 255, 80) : stroke(218, 76, 30, 80);
        strokeWeight(1);
        noFill();
        ...
        for (let i = 0; i <= numPoints; i++) {
            let x = map(i, 0, numPoints, -13, 13); 
            let y = 15 + sin(i * waveLength + frameCount * 0.05) * waveAmplitude; 
            vertex(x, y);
        }
        endShape();
